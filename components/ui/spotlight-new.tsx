...
export const Spotlight = ({
  ...
  return (
    <motion.div
      ...
      className="pointer-events-none fixed inset-0 h-full w-full z-20"
    >
      <motion.div
        animate={{
          x: [0, xOffset, 0],
      ...
      >
        <div
          ...
          className={`absolute top-0 left-0 spotlight-gradient`}
        />
        ...
        <div
          ...
          className={`absolute top-0 left-0 origin-top-left spotlight-gradient`}
        />
      ...
      >
        <div
          ...
          className={`absolute top-0 right-0 spotlight-gradient`}
        />
        ...
        <div
          ...
          className={`absolute top-0 right-0 origin-top-right spotlight-gradient`}
        />
